...
The `egm96_15_subset.gtx` file descends from the [`egm96_15.gtx` file in the PROJ-datumgrid](https://github.com/OSGeo/proj-datumgrid/blob/master/egm96_15.gtx) repository.
...
The original material is still available from the [NGA download server](https://earth-info.nga.mil/php/download.php?file=egm-96interpolation).

The GTX-format version is, however, related to the NOAA/NOS VDatum program.
The format description is available at <https://vdatum.noaa.gov/docs/gtx_info.html#dev_gtx_binary>.
...
Files: egm96_15_subset.gtx
       egm96_15_subset.gtx.aux.xml
Size is 33, 17
...
The intention is to extract the grid nodes inside, or on the border of, the area 8E 58N 16E 54N.
...
grid node at (33, 17), in order to obtain the grid value for (32, 16)?
